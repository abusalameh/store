	...
	<div class="modal-dialog modal-lg" style="width:90%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form v-on:submit.prevent="savePayment()" name="payment">
				<div class="row">
				...
				<div class="form-content">
							...
							<div class="col-md-10 pull-{{trans('lang.page-direction')}}">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="text" name="customerName" disabled v-model="newCustomer.name" class="form-control {{trans('lang.direction')}}-font" >
									</div>
								</div>
							</div>
						</div><!--.form-group-->
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-10 pull-{{trans('lang.page-direction')}}">
								<select class='form-control' dir="{{ trans('lang.direction')}}" v-model="payment.selectedInvoice" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-10 pull-{{trans('lang.page-direction')}}">
									<div class="inputer">
										<div class="input-wrapper">
											<input type="text" name="totalPaid" disabled value="@{{newCustomer.invoices[payment.selectedInvoice].total - newCustomer.invoices[payment.selectedInvoice]._total}}" class="form-control {{trans('lang.direction')}}-font">
										</div>
									</div>
								</div>
							</div><!--.form-group-->
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-10 pull-{{trans('lang.page-direction')}}">
									<div class="inputer">
										<div class="input-wrapper">
											<input type="text" name="remaining" disabled value="@{{ newCustomer.invoices[payment.selectedInvoice]._total }}" class="form-control {{trans('lang.direction')}}-font">
										</div>
									</div>
								</div>
							</div><!--.form-group-->
					...
					<div class="row">
						<div class="form-group" v-show="payment.selectedInvoice">
							...
							<div class="col-md-10 pull-{{trans('lang.page-direction')}}">
								<select class='form-control' dir="{{ trans('lang.direction')}}" v-model="payment.paymentMethod" required="required">
								  <option value="" disabled selected>{{ trans('lang.please select')}}</option>
										...
										<div class="control-group">
											<div class="controls">
												<div class="input-group">
													...
													<input type="text" name="due_to" class="form-control bootstrap-daterangepicker-basic" value="{{ $current_date }}" v-model="payment.due_to" required/>
												</div>
											</div>
										</div>
								</div>
						...
						<div class="form-group" v-show="payment.paymentMethod">
							...
							<div class="col-md-10">
								<div class="inputer">
									<div class="input-wrapper">
										<input type="number" class="form-control" v-model="payment.amount" placeholder="الوصف" v-on:keyup="handleMaxPayment(payment.selectedInvoice)" min="1" required="required">
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				<div class="pull-{{trans('lang.!page-direction')}}">
					<button type="submit" class="btn btn-flat btn-primary">{{ trans('lang.save') }}</button>
